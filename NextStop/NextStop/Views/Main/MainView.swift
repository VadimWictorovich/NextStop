...
struct MainView: View {
    ...
    private let buttOpensListWithAdresses = Button { print ("Tap button tap") } label: { Image(systemName: "chevron.up.circle") }
    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                Spacer()
                HStack() {
                    TextWithGradient(textLabel: "Some text", firstColorGradient: Color(#colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)), secondColorGradient: Color(#colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)),
                                     thirdColorGradient: Color(#colorLiteral(red: 0.8374180198, green: 0.8374378085, blue: 0.8374271393, alpha: 1)), size: 35, weight: .bold)
                        .padding(.leading, 25)
                    ...
                    Button { print ("Tap button tap") }
                        label: { Image(systemName: "plus").font(.system(size: 25, weight: .medium, design: .default)).foregroundColor(.black) }
                            .frame(width: 40, height: 40)
                            .background(gradientBackgroundButton)
                            .cornerRadius(20)
                    Button { print ("Tap button tap") }
                        label: { Image(systemName: "person.circle.fill").font(.system(size: 25, weight: .medium, design: .default)).foregroundColor(.black)}
                            .frame(width: 40, height: 40)
                            .background(gradientBackgroundButton)
                            .cornerRadius(20)
                            .padding(.trailing, 15)
